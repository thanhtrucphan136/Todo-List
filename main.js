...
function createTask(taskName, dueDate, checked) {
  ...
  if (dueDate == "none") {
    ...
    task = new _task__WEBPACK_IMPORTED_MODULE_0__["default"](taskName, dueDate, checked);
  }
  console.log(task);
