...
function createTask(taskName){
    ...
    const task = new _task__WEBPACK_IMPORTED_MODULE_0__["default"](taskName);
    console.log(task);
...
function setNewDueDate(div, dueDate, input, task){
    ...
    newDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(newDueDate, 'MM/dd/yyyy');
