    ...
    if (existingProject) {
      project.tasks.forEach((task) => {
        ...
        if (!existingProject.tasks.some((t) => t.title === task.title)) {
          const newTask = new _task__WEBPACK_IMPORTED_MODULE_0__["default"](task.title, task.dueDate, task.checked);
